...
$site = 'https://www.quicksms1.com/index.php?api/previous/';
$site = 'https://www.quicksms1.com/api/bulksms';

/* Domains to use when rewriting some headers. */
$remoteDomain = 'http://www.quicksms1.com';
$proxyDomain = 'quicksms1.com';
