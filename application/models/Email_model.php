...
class Email_model extends CI_Model {
	...
	function account_opening_email($account_type = '' , $email = '')
	{
		...
		$email_msg		.=	"Your login password : ".$this->c()->get_where($account_type , array('email' => $email))->row()->password."<br />";
	...
	{
		$query			=	$this->c_->get_where($account_type , array('email' => $email));
		if($query->num_rows() > 0)
		{
	...
	function do_email($msg=NULL, $sub=NULL, $to=NULL, $from=NULL)
	{
		...
		$msg	=	$msg."<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"".""."\">&copy; 2017 Quicktel Solution</a></center>";
